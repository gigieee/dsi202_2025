...
SECRET_KEY = "django-insecure-c)u8t+(d31yb5+p$e#y*fymi00@!3*40i5a9p#ix)xq1n2b!y3"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'pawpal', 'templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                'adopt.context_processors.notifications_count',
            ],
        },
    },
]
...
DEBUG = True  # ตรวจให้แน่ใจว่าเปิดใช้งาน
STATIC_URL = '/static/'
